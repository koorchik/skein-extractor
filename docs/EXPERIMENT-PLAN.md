...
| E7 | Relation layer | ν_rel(t); cluster metrics of relation types vs the E0b inventory; triple P/R/F1 with fuzzy matching; recovery of the 8 hand relation types; in-context inventory vs post-hoc canonicalization vs pool-and-name | spike, mid slice: in-context over-collapses (9 types, "uses" spans 7 argument signatures), blind fragments (60 phrases, 35–42 types), soft signature removes wrong merges |
