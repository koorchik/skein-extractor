# 2026-09-17-gemini-mid20-rel-blind-cell-tau90
...
**Arm.** Blind, per cell, as `…-rel-blind-cell` with the vote floor raised to τ 0.90: at τ 0.80 the kNN vote absorbed unrelated phrases into the only type of a cell.
...
| Typed | 39 (32.2%) |
| Pool (in a cell, no type) | 62 (51.2%) |
| Pending (an argument never got a scheme) | 20 (16.5%) |
| Relation types | 6 in 4 cells, 0 with a broader type |
...
|---|---|---|---|---|---|---|---|
| Domain Name → Malware Family | R3 | hosts | 7 |  | 11 | hosts-file (5), hosts-payload (2) | Specifies that the domain or network infrastructure hosts or serves the specified malware for download or distribution. |
| Government Agency → Country | R6 | located-in | 6 |  | 18 | located-in (6) | Identifies the country or geographic territory where the head entity is based, operates, or holds jurisdiction. |
| Malware Family → Malware Family | R1 | contains | 5 |  | 11 | contains-file (5) | Specifies that the source file or container encapsulates or holds the target file or payload. |
| Malware Family → Malware Family | R2 | downloads | 5 |  | 11 | downloads-and-executes (3), downloads (1), downloads-file (1) | Specifies that the source entity retrieves the target file or payload from an external location. |
| Malware Family → Malware Family | R5 | deploys | 4 |  | 16 | deploys (2), delivers-malware (1), delivers-payload (1) | Specifies that the source malware installs, unpacks, drops, or executes the target malware or payload. |
| Threat Actor → Malware Family | R4 | uses | 12 |  | 13 | uses-tool (7), associated-with (1), associated-with-activity (1), associated-with-malware (1), attributed-to (1), operates (1) | Indicates that the threat actor utilizes, deploys, or operates the specified malware or tool. |
...
- Malware Family → Malware Family: 9 (creates-and-executes 2, executes 2, creates-file 1, drops 1, drops-and-executes 1, executes-file 1, …)
...
- Threat Actor → Malware Family: 6 (conducts-activity 1, delivers-payload 1, deploys-malware 1, infects-file 1, tracks-activity-of 1, tracks-activity-using 1)
...
| 11 | 405538 | Кібератака у відношенні операторів телекомунікаці… | 7 | 15 | 32 | 18 | 3 | 2 | 3 |
| 12 | 619229 | Кібератака UAC-0056 на державні організації Украї… | 4 | 15 | 46 | 8 | 3 | 2 | 0 |
| 13 | 703548 | Атака групи UAC-0056 на державні організації Укра… | 6 | 18 | 49 | 8 | 4 | 3 | 1 |
| 14 | 761668 | Онлайн-шахрайство з використанням тематики "грошо… | 3 | 18 | 49 | 11 | 4 | 3 | 0 |
| 15 | 861292 | Кібератака на державні організації України з вико… | 10 | 18 | 59 | 11 | 4 | 3 | 0 |
| 16 | 955924 | Масове розповсюдження стілерів (Formbook, Snake K… | 7 | 27 | 55 | 13 | 5 | 3 | 2 |
| 17 | 971405 | Кібератаки групи UAC-0010 (Armageddon) з використ… | 7 | 27 | 62 | 13 | 5 | 3 | 0 |
| 18 | 987552 | Онлайн-шахрайство з використанням тематики "допом… | 3 | 31 | 60 | 14 | 6 | 4 | 1 |
| 19 | 1229152 | Кібератаки групи UAC-0010 (Armageddon): шкідливі… | 8 | 37 | 62 | 14 | 6 | 4 | 0 |
| 20 | 1545776 | Онлайн-шахрайство з використанням тематики «грошо… | 8 | 39 | 62 | 20 | 6 | 4 | 0 |
